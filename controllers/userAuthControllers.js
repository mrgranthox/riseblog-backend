...
import { EMAIL_VERIF_TEMPLATE, PASSWORD_RESET_TEMPLATE } from '../config/emailTemplate.js'
...
export const sendVerifyOtp = async ( req, res ) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      to: user.email,
      subject: "Blog Post Account Verification OTP",
...
export const sendResetOtp = async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      from: process.env.SENDER_EMAIL,
      to: user.email,
      subject: "Blog Post Password Reset Otp",
