...
import { createPost, deletePost, editPost, getPostBySlug } from '../controllers/postController.js'
...
postRouter.post('/create-post', postAuth, upload.single('coverImage'), createPost)
  ...
  postRouter.patch('/edit-post/:id', postAuth, upload.single('coverImage'), authorizePostOwner,  editPost)
